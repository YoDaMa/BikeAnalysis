...
def plotstft(sxx, Fs=100):
    ...
    with plt.xkcd():
        ...
        for dft in sxx:
            ...
            peaks_x = signal.find_peaks_cwt(mag, np.arange(1,10))
            print(peaks_x,faxis[peaks_x],mag[peaks_x])
            # !! THIS NEEDS TO BE COMPLETED FOR PEAK TRACKING !!
            # refer to find_peaks_cwt for more info.
